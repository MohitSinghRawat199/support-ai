...
//     const embedcode = `<script src="${process.env.NEXT_PUBLIC_BASE_URL}/chatBot.js"
...
//                         className='text-lg font-semibold cursor-pointer'>Support <span className='text-zinc-400'>AI</span></div>
//                     <button className='px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition ml-auto mb-2'
...
//                     <h1 className="text-2xl font-semibold text-gray-900 mb-2">Embed ChatBot</h1>
//                     <p>Copy and paste this code before <code>&lt;/body&gt;</code></p>
//                     <div className="relative bg-zinc-900 text-zinc-100 rounded-xl text-sm font-mono p-4 mb-10 overflow-x-auto">
        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='text-lg font-semibold cursor-pointer' onClick={() => navigate.push("/")}>AI<span className='text-zinc-400'>Support</span></div>
