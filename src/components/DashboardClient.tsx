        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            ...
            >
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='text-lg font-semibold tracking-tight' onClick={() => navigate.push("/")}>AI <span className='text-zinc-400'>Support</span></div>
            ...
            <div className='flex justify-center px-14 py-14 mt-20'>
                <motion.div
                    className='w-full bg-white rounded-2xl shadow-xl p-10'
